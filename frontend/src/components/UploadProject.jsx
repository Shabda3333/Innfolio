...
const UploadProject = ({ closePopup }) => {
  ...
  //   };
  return (
    <div className="popup-background bg-[rgba(0,0,0,0.8)] w-screen h-screen flex justify-center items-center">
      <div className="upload-project-popup bg-black w-[70rem] h-[48rem] flex flex-col gap-9 justify-between items-end p-20 border-[1px] border-dark-grey px-20 rounded-[1.875rem] overflow-y-auto">
